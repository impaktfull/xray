---
title: xray_shared_preferences_inspector
description: Key-value inspector for SharedPreferences.
---

[![pub package](https://img.shields.io/pub/v/xray_shared_preferences_inspector.svg)](https://pub.dev/packages/xray_shared_preferences_inspector)
